    ...
    <section className="relative flex flex-col items-center justify-center py-12 lg:py-20">
      <div className='text-center'>
        {/* <div className="flex mx-auto text-center gap-2"> */}
          <span className='text-sm text-primary font-medium tracking-tighter bg-primary/10 px-4 py-2 rounded-full'>Digital Transformation Service</span>
            {/* <Link href="/dashboard">
        ...
        {/* </div> */}
          <div className="text-center mt-8 text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-semibold tracking-tighter">
            <h1>
              Empowering Your Business Through <span className='block p-2 -mt-1 bg-gradient-to-r from-blue-500 via-teal-500 to-green-500 text-transparent bg-clip-text'>"Digital Innovation"</span>
            </h1>
          </div>
