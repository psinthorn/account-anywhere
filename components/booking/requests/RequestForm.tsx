// Create request form for booking
// Use conform-to/react for form state management
// Zod for form validation
// use prismaClient to save data to database
...
import { CreateRequest } from '@/app/actions/actions'
import { parseWithZod } from '@conform-to/zod'
import { useForm } from '@conform-to/react'
import { invoiceSchema } from '@/app/utils/zodSchemas'
import { formatCurrency } from '@/app/utils/formatCurrency'

const CreateRequestForm = ({userData}: any ) => {
  ...
  // to get the last result from the action
  // use conform-to/react hook useActionState
